...
class ClientCallServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RunDeploy = channel.unary_stream(
        ...
        request_serializer=conn__pb2.ClientCallRequest.SerializeToString,
        response_deserializer=conn__pb2.ClientCallResponse.FromString,
        )
...
def add_ClientCallServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'RunDeploy': grpc.unary_stream_rpc_method_handler(
          servicer.RunDeploy,
          request_deserializer=conn__pb2.ClientCallRequest.FromString,
          response_serializer=conn__pb2.ClientCallResponse.SerializeToString,
      ),
  }
